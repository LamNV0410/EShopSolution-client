...
export const AppRoutes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () => import('./features/categories-management/categories-management.module').then(m => m.CategoriesManagementModule)
            },
            {
                path: 'products-management',
                loadChildren: () => import('./features/products-management/products-management.module').then(m => m.ProductsManagementModule)
            },
            {
                path: 'charts',
